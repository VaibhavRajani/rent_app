// Typography tokens for consistent text styling throughout the application
...
export function getTypography(
  ...
  return typography[category][
    token as keyof (typeof typography)[typeof category]
  ];
}

// Helper function to get semantic typography value
export function getSemanticTypography(
  category: keyof typeof semanticTypography,
  token: string
) {
  return semanticTypography[category][
    token as keyof (typeof semanticTypography)[typeof category]
  ];
}
